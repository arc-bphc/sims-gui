...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_3.setText(_translate("Form", "View Purchase Requests"))
        self.label_5.setText(_translate("Form", "Administration Panel"))
        self.pushButton.setText(_translate("Form", "View Active Projects"))
