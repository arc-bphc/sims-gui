...
""))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_3.setText(_translate("Form", "View Purchase Requests", None))
        self.label_5.setText(_translate("Form", "Administration Panel", None))
        self.pushButton.setText(_translate("Form", "View Active Projects", None))
