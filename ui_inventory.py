...
""))
        ...
        self.gridLayout.addWidget(self.treeView, 4, 0, 1, 2)
        self.backButton = QtGui.QPushButton(self.centralwidget)
        self.backButton.setMinimumSize(QtCore.QSize(50, 50))
        self.backButton.setStyleSheet(_fromUtf8("QPushButton {padding: 10px}\n"
""))
        ...
        self.gridLayout.addWidget(self.listView, 4, 2, 1, 2)
