...
"")
        ...
        self.gridLayout.addWidget(self.exitButton, 6, 2, 1, 1)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem2, 1, 1, 1, 1)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem3, 1, 3, 1, 1)
        self.fingerprintButton = QtWidgets.QPushButton(enrolFingerWindow)
        self.fingerprintButton.setObjectName("fingerprintButton")
        self.gridLayout.addWidget(self.fingerprintButton, 5, 2, 1, 1)
    ...
    def retranslateUi(self, enrolFingerWindow):
        ...
        self.fingerprintButton.setText(_translate("enrolFingerWindow", "Scan Fingerprint"))
