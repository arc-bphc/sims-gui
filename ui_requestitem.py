...
"")
        ...
        self.requestItemButton = QtWidgets.QPushButton(requestItemWindow)
        self.requestItemButton.setObjectName("requestItemButton")
    ...
    def retranslateUi(self, requestItemWindow):
        ...
        self.requestItemButton.setText(_translate("requestItemWindow", "Request Item"))
