...
""))
        ...
        self.gridLayout.addWidget(self.buttonBox, 4, 0, 1, 3, QtCore.Qt.AlignHCenter)
        spacerItem1 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem1, 5, 0, 1, 3)
        self.tableView = QtGui.QTableView(requestItemWindow)
        ...
        self.gridLayout_2.addWidget(self.project, 0, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.item, 1, 2, 1, 1)
        ...
        self.gridLayout_2.addItem(spacerItem4, 3, 0, 1, 4)
        self.requestItemButton = QtGui.QPushButton(requestItemWindow)
        self.requestItemButton.setObjectName(_fromUtf8("requestItemButton"))
        self.gridLayout_2.addWidget(self.requestItemButton, 4, 0, 1, 4, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, requestItemWindow):
        ...
        self.requestItemButton.setText(_translate("requestItemWindow", "Request Item", None))
