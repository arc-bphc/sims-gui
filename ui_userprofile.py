...
class Ui_userWindow(object):
    def setupUi(self, userWindow):
        ...
        userWindow.setStyleSheet(_fromUtf8("QPushButton {padding: 20px}\n"
...
""))
        ...
        self.gridLayout.addWidget(self.viewItemsButton, 5, 1, 1, 1)
        ...
        self.userBox = QtGui.QWidget(userWindow)
        self.userBox.setMaximumSize(QtCore.QSize(400, 60))
        self.userBox.setObjectName(_fromUtf8("userBox"))
        self.horizontalLayout = QtGui.QHBoxLayout(self.userBox)
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.label_2 = QtGui.QLabel(self.userBox)
        ...
        self.comboBox = QtGui.QComboBox(self.userBox)
        self.comboBox.setMinimumSize(QtCore.QSize(200, 40))
        self.comboBox.setMaximumSize(QtCore.QSize(300, 16777215))
        self.comboBox.setObjectName(_fromUtf8("comboBox"))
        self.horizontalLayout.addWidget(self.comboBox)
        self.gridLayout.addWidget(self.userBox, 0, 2, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignTop)
