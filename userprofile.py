...
"")
        ...
        self.gridLayout.addWidget(self.pushButton_4, 2, 1, 1, 1, QtCore.Qt.AlignTop)
        ...
        self.comboBox.addItem("")
        self.gridLayout.addWidget(self.comboBox, 0, 2, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.pushButton_2, 3, 1, 1, 1, QtCore.Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.pushButton_3, 6, 1, 1, 1, QtCore.Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.pushButton, 5, 1, 1, 1, QtCore.Qt.AlignTop)
        self.pushButton_5 = QtWidgets.QPushButton(Dialog)
        self.pushButton_5.setObjectName("pushButton_5")
        self.gridLayout.addWidget(self.pushButton_5, 4, 1, 1, 1, QtCore.Qt.AlignTop)
