...
""))
        ...
        self.pushButton_4 = QtGui.QPushButton(userWindow)
        ...
        self.pushButton_3 = QtGui.QPushButton(userWindow)
        ...
        self.pushButton_5 = QtGui.QPushButton(userWindow)
        ...
        self.pushButton_6 = QtGui.QPushButton(userWindow)
    ...
    def retranslateUi(self, userWindow):
        ...
        self.pushButton_4.setText(_translate("userWindow", "Inventory", None))
        ...
        self.pushButton_2.setText(_translate("userWindow", "View My Items", None))
        self.pushButton_3.setText(_translate("userWindow", "Reset PIN", None))
        self.pushButton.setText(_translate("userWindow", "Edit Details", None))
        self.pushButton_5.setText(_translate("userWindow", "Purchase Request", None))
        self.pushButton_6.setText(_translate("userWindow", "🔒 Lock", None))
