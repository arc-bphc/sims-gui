...
""))
        ...
        self.label_6.setStyleSheet(_fromUtf8("font: 75 20pt \"Noto Sans\";"))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.gridLayout_2.addWidget(self.label_6, 4, 1, 1, 1, QtCore.Qt.AlignHCenter)
        self.gridLayout = QtGui.QGridLayout()
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.currentPwd = QtGui.QLineEdit(resetPinWindow)
        self.currentPwd.setMaxLength(4)
        self.currentPwd.setEchoMode(QtGui.QLineEdit.Normal)
        self.currentPwd.setObjectName(_fromUtf8("currentPwd"))
        self.gridLayout.addWidget(self.currentPwd, 0, 2, 1, 1)
        ...
        self.newPwd = QtGui.QLineEdit(resetPinWindow)
        self.newPwd.setMaxLength(4)
        self.newPwd.setEchoMode(QtGui.QLineEdit.Normal)
        self.newPwd.setObjectName(_fromUtf8("newPwd"))
        self.gridLayout.addWidget(self.newPwd, 1, 2, 1, 1)
