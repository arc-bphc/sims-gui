...
""))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#aa0000;\">This operation cannot be reversed!</span></p></body></html>", None))
        self.label_5.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600;\">Reset PIN</span></p></body></html>", None))
        self.label_2.setText(_translate("Form", "New PIN", None))
        self.label.setText(_translate("Form", "Current PIN", None))
